...
import { TYPEWRITER_SPEED, FONT_PIXEL, SHADOW_TEXT, DIALOG_BOX_HEIGHT } from '../utils/Constants.js';
...
export default class DialogBox {
    constructor(scene) {
        ...
        const boxY = Layout.H - BOX_HEIGHT - BOX_MARGIN;
        ...
        bg.fillRoundedRect(BOX_MARGIN + 3, boxY + 3, Layout.W - BOX_MARGIN * 2, BOX_HEIGHT, 6);

        // Parchment base
        bg.fillStyle(0xE8D5B0, 0.96);
        bg.fillRoundedRect(BOX_MARGIN, boxY, Layout.W - BOX_MARGIN * 2, BOX_HEIGHT, 6);
        ...
        for (let y = boxY + 2; y < boxY + BOX_HEIGHT - 2; y += 3) {
            ...
            bg.fillRect(BOX_MARGIN + 4, y, Layout.W - BOX_MARGIN * 2 - 8, 1);
        }

        // Aged edges
        bg.fillStyle(0xC4A060, 0.15);
        bg.fillRoundedRect(BOX_MARGIN, boxY, Layout.W - BOX_MARGIN * 2, 3, { tl: 6, tr: 6, bl: 0, br: 0 });
        bg.fillRoundedRect(BOX_MARGIN, boxY + BOX_HEIGHT - 3, Layout.W - BOX_MARGIN * 2, 3, { tl: 0, tr: 0, bl: 6, br: 6 });

        // Border
        bg.lineStyle(2, 0x8B6B3D, 0.5);
        bg.strokeRoundedRect(BOX_MARGIN, boxY, Layout.W - BOX_MARGIN * 2, BOX_HEIGHT, 6);
        ...
        this.dialogText = scene.add.text(
            ...
            '',
            {
                ...
                fontSize: '12px',
                color: TEXT_COLOR,
                wordWrap: { width: Layout.W - BOX_MARGIN * 2 - BOX_PADDING * 2 },
                lineSpacing: 6,
        ...
        this.arrow = scene.add.text(
            Layout.W - BOX_MARGIN - BOX_PADDING - 16,
