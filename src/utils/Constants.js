...
export const COCHONNET_IMPACT_DAMPING = 0.45;  // Global: force transmise au cochonnet (-10% vs 0.5)
...
export const CHAR_SCALE_PETANQUE = 0.85;       // PetanqueScene gameplay
...
export const COCHONNET_RADIUS = 11;
